---
layout: post
title: Backdooring Diffie Hellman?!
categories: [Cryptography, number theory, algorithms]
---
...
This is a writeup for the picoCTF 2022 event. (I don't like picoCTF, I like Crypto though, I nonchalantly solved the Crypto challenge with my team)
...
Cool; It can clearly be solved by backdooring Diffie Hellman. Let's go over it.

We know that 

$$c = 3^{\text{Our beloved flag}} \mod n$$

Checking Mr. Wong's [paper](https://eprint.iacr.org/2016/644.pdf), we clearly find this:


![Alt text](/assets/wongi.png)

Cool, he presents an equation of the form 

$$y = g^x \mod p$$

Which is.. Exactly what we have. From this (I did not do it with Sage but rather with rsys), getting the flag is rather trivial.

It was a bad problem. I didn't like it.